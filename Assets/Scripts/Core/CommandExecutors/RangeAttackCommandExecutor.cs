...
{
    public class RangeAttackCommandExecutor : CommandExecutorBase<IAttackCommand>
    {
        ...
        public sealed class AttackOperation : IAwaitable<AsyncExtensions.Void>
	{
    		...
    		private readonly RangeAttackCommandExecutor _attackCommandExecutor;
    		private readonly IAttackable _target;

    		private bool _isCancelled;

    		public AttackOperation(RangeAttackCommandExecutor attackCommandExecutor, IAttackable target)
    		{
        		_target = target;
