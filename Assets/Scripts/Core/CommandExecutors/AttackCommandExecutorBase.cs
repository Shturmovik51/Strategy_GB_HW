...
{
    public class AttackCommandExecutorBase : CommandExecutorBase<IAttackCommand>
    {
        [SerializeField] private Animator _animator;
        [SerializeField] private StopCommandExecutor _stopCommandExecutor;

        protected IHealthHolder OurHealth;
        protected float AttackingDistance;
        protected int AttackingPeriod;
        ...
        public virtual void StartAttackingTargets(IAttackable target)
        {
        ...
        public sealed class AttackOperation : IAwaitable<AsyncExtensions.Void>
	{
    		...
    		private readonly AttackCommandExecutorBase _attackCommandExecutor;
    		private readonly IAttackable _target;

    		private bool _isCancelled;

    		public AttackOperation(AttackCommandExecutorBase attackCommandExecutor, IAttackable target)
    		{
        		_target = target;
    		...
    		private void AttackAlgorythm(object obj)
    		{
        		while (true)
        		{
            			if (
                			...
                			|| _attackCommandExecutor.OurHealth.Health == 0
                			|| _target.Health == 0
                			|| _isCancelled
                			)
            			{
